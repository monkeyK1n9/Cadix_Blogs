...
You are **hooked**, using more than 5 softwares to design, build, collaborate and monitor your next construction project.
You are **product slave**, bound to pay huge amounts for licenses.
...
- :white_check_mark: Blog post
- :white_large_square: Project creation
- :white_large_square: Versioning system
- :white_large_square: Messaging
- :white_large_square: Project visualization and editing
- :white_large_square: Reporting and construction follow-up
- :white_large_square: Project planning
